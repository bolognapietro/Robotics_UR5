...
BLENDER_MODELS_PATH = "BLENDER_MODELS_PATH"
...
def random_model(path: str) -> str:
    ...
    return join(path,"X2-Y2-Z2.stl")#random.choice(models))

def random_position(x_min: float = 0, x_max: float = 1, y_min: float = 0.15, y_max: float = 0.8, z: float = 0.99, precision: int = 3) -> tuple:
    ...
    try:
        while True:
            ...
            if option == 1:
                ...
                elif not new_pos_x.replace(".", "", 1).isdigit():
                    continue
                else:
                ...
                elif not new_pos_y.replace(".", "", 1).isdigit():
                    continue
                else:
                ...
                elif not new_or_x.replace(".", "", 1).isdigit():
                    continue
                else:
                ...
                elif not new_or_y.replace(".", "", 1).isdigit():
                    continue
                else:
                ...
                elif not new_or_z.replace(".", "", 1).isdigit():
                    continue
                else:
